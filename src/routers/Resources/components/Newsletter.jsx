        ...
        <div className="newsletter-content">
          <div className="newsletter-left">
            ...
            <div className="newsletter-field">
              <input type="text" name="text" id="text" placeholder="Enter your email adress" />
            ...
            <div className="our-members">
              <div className="avatars">
                ...
                <img src={"https://images.unsplash.com/photo-1601455763557-db1bea8a9a5a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=912&q=80"} alt="" />
              </div>
              <span>Join over <span>4,000+</span> other</span>
            </div>
          </div>
